...
def compare_barycenter ( ):
    o_file       = tuna.io.read ( file_name = '/home/nix/sync/tuna/sample_data/g094_adhoc_prb.fits' )
    a_barycenter = o_file.get_array ( )
    a_cube       = tuna.data_cube.cube ( tan_data = a_barycenter )

    o_gold_file         = tuna.io.read ( file_name = '/home/nix/sync/tuna/sample_data/g094_compever_prb.ad2' )
