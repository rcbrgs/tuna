...
class unit_test_arc_segmentation_center_finder ( unittest.TestCase ):
    ...
    def test_center_finder ( self ):
        wrapped = tuna.io.read ( self.here + "/tuna/test/unit/unit_io/G094_03_wrapped_phase_map.fits" )
        noise = tuna.io.read ( self.here + "/tuna/test/unit/unit_io/G094_04_noise.fits" )
