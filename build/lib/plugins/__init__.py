...
An analogous situation motivated the development of the plugin system of [CosmoSIS]_, where benefits and costs of a modular design were considered, regarding their field of cosmological parameter estimation. Their cost and benefits analysis can be summarized as below.
