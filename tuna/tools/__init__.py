"""This namespace aggregates modules that are meant to be called as library
routines; in other words, if the user is expected to use some tool "X" contained
in Tuna, he is expected to call it as "tuna.tools.X", or a shorthand form of that
if the user creates an alias for it.
"""
...
try:
    ...
    print ( "An exception happened while importing the plot module. It will be "\
            "ignored, but calls to tuna.tools.plot functions will fail. " \
            "Exception. {}".format(e))
