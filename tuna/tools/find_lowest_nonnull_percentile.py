...
def find_lowest_nonnull_percentile(array):
    """Find the lowest value, starting at 1, which makes numpy.percentile return
    a non-null value when fed the input array.
    ...
    * lower_percentile : integer
        The lowest percentile that is not null; if all data is null, this return
        value will be 1.
    """
    lower_percentile = 1
