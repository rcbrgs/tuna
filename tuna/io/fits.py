...
import tuna
import warnings
import IPython #new add by Julien Penguen 24/07/2017
import math #new add by Julien Penguen 24/07/2017
...
class fits ( file_reader ):
    ...
    * photons : dictionary : defaults to None
    ...
    def __init__ ( self,
                   ...
                   file_name = None,
                   metadata = { },
                   photons = {} ): #modified by Julien Penguen 13/09/2017
        ...
        self.__hdu_list_info=None #new add by Julien Penguen 24/07/2017
    ...
    def read ( self ):
        ...
        try:
            ...
            self.__hdu_list_info=hdu_info #new add by Julien Penguen 24/07/2017
