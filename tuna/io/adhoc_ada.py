...
import matplotlib.pyplot as plt #new add by Julien Penguen 09/10/2017
...
class ada ( file_reader ):
    ...
    * file_name : string : defaults to None
    ...
    def __init__ ( self,
        ...
        self.__file_name = file_name #new add by Julien Penguen 30/06/2017
        self.__array = array
        self.__metadata = { }
        self.__photons = { }
        self.__file_path=dirname ( file_name ) #new add by Julien Penguen 30/06/2017
    ...
    def read ( self,channel_test=1 ):
        ...
        if self.__file_name:
            ...
            #------------------------------------#
            #New add by Julien Penguen 11/10/2017

            if ( self.__file_name.lower ( ).startswith ( ".adt", -4 ) ):
                #self._read_adt ( )
                self._read_adt (channel_test= channel_test)# New add by Julien Penguen 10/10/2017
            else:
    ...
    def _read_adt ( self,channel_test=1 ):
        ...
        for element in range ( len ( photon_files ) ):
            ...
            #--------------------------------------------#
            #for unittest add by julien Penguen 10/10/2017
            if channel_test == -1:
