...
def g092_compare_barycenter ( ):
    ...
    tuna.io.write ( file_name   = '9_g092_gold_standard_comparison.fits',
                    array       = comparison,
                    file_format = 'fits' )
...
def g092_unwrap_phase_map ( ):
    ...
    high_res_FP_phase_map_tool = tuna.tools.phase_map_creation.high_resolution_Fabry_Perot_phase_map_creation ( array = g092_array,wrapped_phase_map_algorithm = tuna.tools.phase_map_creation.create_barycenter_array, channel_threshold = 1, bad_neighbours_threshold = 7, noise_mask_radius = 6 )
    ...
    tuna.io.write ( file_name   = '7_g092_orders.fits',
                    ...
                    file_format = 'fits' )    
    tuna.io.write ( file_name   = '8_g092_unwrapped_phase_map.fits',
